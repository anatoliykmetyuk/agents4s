...
- Specification Generation: [workflows/actor-spec.md](workflows/actor-spec.md) - defines how to generate an actor system spec from a user prompt. Use it when the user requests to generate a new or update an existing specification.
- Project Generation: [workflows/actor-harness.md](workflows/actor-harness.md) - defines how to generate a Scala 3 Apache Pekko Typed project from an actor system spec. Use it when the user requests to generate a new or update an existing project.
